...
| `daily_tracking_update` | User wants to update medication, diet, exercise, sleep, or checkup CSVs | No dedicated low-level event; host LLM may update `04_tracking/*.csv` under the direct-write rules |
